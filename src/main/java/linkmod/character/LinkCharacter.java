...
import linkmod.cards.Defend_L;
import linkmod.cards.Flurry_Rush;
import linkmod.cards.Strike_L;
import linkmod.relics.Heart_Of_A_Champion;

import java.util.ArrayList;

import static linkmod.LinkMod.characterPath;
import static linkmod.LinkMod.makeID;

public class LinkCharacter extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Champion"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass LINK_CHAMPION;
        @SpireEnum(name = "CHARACTER_CHAMPION_BLUE") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "CHARACTER_CHAMPION_BLUE") @SuppressWarnings("unused")
        public static CardLibrary.LibraryType LIBRARY_COLOR;
    }

    public LinkCharacter() {
        super(NAMES[0], Enums.LINK_CHAMPION,
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(Strike_L.ID);
        retVal.add(Strike_L.ID);
        retVal.add(Strike_L.ID);
        retVal.add(Strike_L.ID);
        retVal.add(Defend_L.ID);
        retVal.add(Defend_L.ID);
        retVal.add(Defend_L.ID);
        retVal.add(Defend_L.ID);
        retVal.add(Flurry_Rush.ID);
    ...
    public ArrayList<String> getStartingRelics() {
        ...
        retVal.add(Heart_Of_A_Champion.ID);
    ...
    private final Color cardRenderColor = Color.TEAL.cpy(); //Used for some vfx on moving cards (sometimes) (maybe)
    private final Color cardTrailColor = Color.TEAL.cpy(); //Used for card trail vfx during gameplay.
    private final Color slashAttackColor = Color.TEAL.cpy(); //Used for a screen tint effect when you attack the heart.
    @Override
